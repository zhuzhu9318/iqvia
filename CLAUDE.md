...
IQVIA Market Intelligence Platform: upload IQVIA Excel datasets, auto-detect schema, normalise products/ingredients, AI-categorise, compute deterministic market metrics (share, growth, opportunity), and generate grounded strategic insights — demoable without login in v1.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "190992997+zhuzhu9318@users.noreply.github.com"
  git config user.name "zhuzhu9318"
  ```
